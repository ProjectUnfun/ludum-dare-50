class GameMap {
    constructor(
        ...
        this.deco1LayerName = deco1LayerName; // Decorative under player layer
        this.deco2LayerName = deco2LayerName; // Decorative over player layer
        this.createMap();
    }
    ...
    createMap() {
        ...
        // Ensure the Deco2 layer renders above player
